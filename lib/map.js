define(["map/clientlayer", "map/labelslayer",
  ...
  function (ClientLayer, LabelsLayer, d3, L, moment, LocationMarker, rbush) {
    ...
    */
    ...
    var iconOffline = { color: "#999999", fillColor: "#aaaaaa", radius: 3, fillOpacity: 0.5, opacity: 0.5, weight: 1, className: "stroke-first" }
    var iconLost    = { color: "#999999", fillColor: "#aaaaaa", radius: 6, fillOpacity: 0.8, opacity: 0.8, weight: 1, className: "stroke-first" }
    var iconAlert   = { color: "#999999", fillColor: "#aaaaaa", radius: 6, fillOpacity: 0.8, opacity: 0.8, weight: 1, className: "stroke-first" }
    ...
    return function (config, linkScale, sidebar, router, buttons) {
      ...
      clientLayer.setZIndex(6)

      var labelsLayer = new LabelsLayer()
      labelsLayer.addTo(map)
      labelsLayer.setZIndex(5)
      ...
      function updateView(nopanzoom) {
        ...
        if (highlight !== undefined)
          if (highlight.type === "node") {
            ...
            if (m)
              m.setStyle({ color: "#dc0067", weight: 5, fillOpacity: 1, opacity: 0.7, className: "stroke-first" })
